...
FDROID_CATEGORY_MAP = {
    ...
    # security
    "File Encryption & Vault": "security",
    "Firewall": "security",
    ...
    "Cloud Storage & File Sync": "productivity",
    ...
    "App Store & Updater": "development",
    "Code & Forge": "development",
...
def guess_category(app_id: str, text: str = "") -> str:
    ...
    if has(
        ...
        return "health"
    if has("weather", "forecast", "meteo", "radar", "storm", "temperature", "windy", "barometer"):
        return "weather"
...
def category_from_index(
    app_id: str, categories: list[str], summary: str = "", name: str = ""
) -> str:
